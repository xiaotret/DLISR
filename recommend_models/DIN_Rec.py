...
from model_component.sequence import DNN, AttentionSequencePoolingLayer
...
class DIN_Rec (object):
    ...
    def set_attribute(self):
        ...
        self.NI_emb_dim = new_Para.param.implict_feat_dim
    ...
    def set_embedding_matrixs(self):
        ...
        # API embedding
        self.i_factors_matrix = np.zeros((meta_data.api_num + 1, new_Para.param.implict_feat_dim))
    ...
    def set_embedding_layers(self):
        ...
        self.api_implict_emb_layer = Embedding(self.all_api_num + 1,
                                                new_Para.param.implict_feat_dim,
