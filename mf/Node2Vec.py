...
class args(object):
    def __init__(self,node2vec_path):
        ...
        self.m_embedding=os.path.join(node2vec_path,'m_embedding.csv')
        self.a_embedding = os.path.join(node2vec_path,'a_embedding.csv')
        self.model_path=os.path.join(node2vec_path,'word2vec.whole_model')
