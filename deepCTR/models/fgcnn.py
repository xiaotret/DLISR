...
from deepCTR.input_embedding import create_singlefeat_inputdict, create_varlenfeat_inputdict, get_linear_logit
from deepCTR.input_embedding import get_inputs_embedding
