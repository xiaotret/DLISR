...
class CrossNet(Layer):
    """The Cross Network part of Deep&Cross Network whole_model,
...
class InteractingLayer(Layer):
    """A Layer used in AutoInt that whole_model the correlations between different feature fields by multi-head self-attention mechanism.
